...
namespace Week7LabPin.Controllers
{
    public class InterestsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Image,Comment,URL")] Interest interest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Image,Comment,URL")] Interest interest)
        {
            if (ModelState.IsValid)
            {
